...
EMAX_BTN = int(environ.get('EMAX_BTN', "7"))
S_GROUP = environ.get('S_GROUP',"https://t.me/at3movies")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/+BVP4yf8HHEFmNmJl")
...
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>Dᴇᴀʀ {mention}\n\nYour Request To Jᴏɪɴ {title}  Was Approved 🔆</b>")
APPROVED = environ.get("APPROVED_WELCOME", "on").lower()
APPROVE_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('APPROVE_ID', '').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+BVP4yf8HHEFmNmJl')
OWN_LNK = environ.get('S_GROUP',"https://t.me/+BVP4yf8HHEFmNmJl")
MVG_LNK = environ.get('S_GROUP',"https://t.me/+BVP4yf8HHEFmNmJl")
